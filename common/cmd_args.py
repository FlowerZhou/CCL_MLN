...
cmd_opt.add_argument('-embedding_size', default=64, type=int, help='embedding size')
cmd_opt.add_argument('-gcn_free_size', default=32, type=int, help='embedding size of GCN concat params')
cmd_opt.add_argument('-slice_dim', default=8, type=int, help='slice dimension of posterior params')
